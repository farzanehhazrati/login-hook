...
<c:choose>
	...
	<c:otherwise>
		...
		<aui:input label="<%= loginLabel %>" name="login" showRequiredLabel="<%= false %>" type="text" value="<%= login %>" style=" width:150px; direction: ltr!important">
					<aui:validator name="required" />
				</aui:input>

				<aui:input name="password" showRequiredLabel="<%= false %>" type="password" value="<%= password %>" style="width:150px; direction: ltr!important">
					<aui:validator name="required" />
				</aui:input>
     ...
     <liferay-ui:captcha url="<%= captchaURL %>" />
			...
			<aui:button-row>
				<aui:button type="submit" value="sign-in" style="
    margin-top: 10px;"/>
			</aui:button-row>
		</aui:form>
